...
public class GlusterMemoryPool {
    ...
    @XmlElement(name = "hot_count", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer hotCount;
    @XmlElement(name = "cold_count", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer coldCount;
    @XmlElement(name = "padded_size", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer paddedSize;
    @XmlElement(name = "alloc_count", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer allocCount;
    @XmlElement(name = "max_alloc", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer maxAlloc;
    @XmlElement(name = "pool_misses", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
    protected Integer poolMisses;
    @XmlElement(name = "max_stdalloc", type = String.class)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "int")
