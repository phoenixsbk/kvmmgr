    ...
    extends BaseResource
{
    ...
    @XmlElement(name = "virt_service", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean virtService;
    @XmlElement(name = "gluster_service", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean glusterService;
    @XmlElement(name = "threads_as_cores", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean threadsAsCores;
    @XmlElement(name = "tunnel_migration", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean tunnelMigration;
    @XmlElement(name = "trusted_service", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean trustedService;
    @XmlElement(name = "ha_reservation", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean haReservation;
    @XmlElement(name = "optional_reason", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean optionalReason;
    @XmlElement(name = "ballooning_enabled", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
     ...
     *     
     */
    public Boolean isHaReservation() {
     ...
     *     
     */
    public Boolean isOptionalReason() {
     ...
     *     
     */
    public Boolean isBallooningEnabled() {
