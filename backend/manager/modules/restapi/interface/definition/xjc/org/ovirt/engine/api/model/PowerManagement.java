...
public class PowerManagement {
    ...
    @XmlElement(name = "automatic_pm_enabled", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean automaticPmEnabled;
    @XmlElement(name = "kdump_detection", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
     ...
     *     
     */
    public Boolean isAutomaticPmEnabled() {
     ...
     *     
     */
    public Boolean isKdumpDetection() {
