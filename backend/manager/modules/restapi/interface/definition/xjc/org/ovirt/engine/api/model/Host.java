    ...
    extends BaseResource
{
    ...
    @XmlElement(name = "override_iptables", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean overrideIptables;
    protected String protocol;
    @XmlElement(name = "reboot_after_installation", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    ...
    @XmlElement(name = "numa_supported", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean numaSupported;
    @XmlElement(name = "live_snapshot_support", type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "boolean")
     ...
     *     
     */
    public Boolean isLiveSnapshotSupport() {
