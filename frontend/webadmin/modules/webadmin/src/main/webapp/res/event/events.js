	...
	$.ajax({
		...
		success : function(data) {
			...
			for (var i in allevents) {
				if (allevents[i].correlation_id == null) {
					allevents[i].correlation_id = "";
				}
			}
			$("#eventstable").dataTable({
				...
				"columnDefs" : [ {
					...
					"target" : [2],
					"render" : function (data, m, full, meta) {
